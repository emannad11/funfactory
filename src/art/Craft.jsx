  ...
  const experiments = [
    {
      id: 2,
      title: "Paper Crane",
      img: "/src/assets/paper crane.jpg",
...
text: `Make a Paper Crane. You’ll need: A square sheet of paper. Instructions:  Fold the paper diagonally both ways, then unfold.  Fold it in half up–down and side–side, then unfold.Bring corners together to make a small square.Fold both sides to the middle, then flatten into a diamond. Fold long sides to the middle again.Fold down wings on both sides.Fold one tip down for the head. Gently pull wings apart — your paper crane is ready!`,
    },
    {
      id: 3,
      title: "Paper Lily",
      img: "/src/assets/lily.jpg",
  ...
  <>
    ...
    text: `Make a Paper Lily. You’ll need: A square sheet of paper. Instructions: Fold the paper diagonally both ways, then unfold. Fold it in half up–down and side–side, then unfold. Bring corners together to make a small square.Fold triangle flaps to the center line on both sides. Fold top corners down, then unfold to form creases.Open the flaps and fold them upward to make petals. Gently curl each petal outward using a pencil.Your paper lily is complete!`,

    },
    {
      id: 4,
      title: "Paper Swan",
      img: "/src/assets/swannn.jpeg",
...
text: `Make a Paper Swan. You’ll need: A square sheet of paper. Instructions:  Fold the paper diagonally to make a triangle.  Fold it again to make a smaller triangle, then unfold. Fold both sides to the center line to make a kite shape. Fold the bottom point up to form the neck.  Fold the tip down for the head. Gently pull wings out and flatten the base.Your elegant paper swan is ready!.`,

    },
    {
      id: 5,
      title: "Paper Elephant",
      img: "/src/assets/el.jpg",
...
text: `Make a Paper Elephant. You’ll need: A square sheet of paper. Instructions: Fold the paper diagonally and unfold. Fold both sides to the center line. Fold down the top corner to form the head. Fold the tip of the head up slightly for the trunk. Fold back corners for ears. Shape the body and legs with small folds. Your cute paper elephant is ready!`,
  ...
  <>
    ...
    <p>
      <strong>You’ll need:</strong><br />
      - A square sheet of colorful paper
    </p>
    <p>
      <strong>Instructions:</strong><br />
...
text: `Make a Paper Butterfly. You’ll need: A square sheet of colorful paper. Instructions:Fold the paper diagonally both ways and unfold. Fold it in half horizontally and vertically, then unfold again.Bring two sides together to form a triangle.Fold the top corners of the triangle down to meet the bottom point.Flip and fold the top tip down slightly for the butterfly’s head.Gently fold the body in half to make the wings pop out.Your pretty butterfly is ready! `,
  ...
  <>
    ...
    text: `Make a Paper Boat. You’ll need: One rectangular sheet of paper. Instructions:Fold the paper in half from top to bottom. Fold it again side to side, then unfold to see the center line.Fold the top corners down to the center to make a triangle. Fold the bottom edge of the paper up on both sides. Pull the two corners apart to form a square.Fold the bottom corners up again, then pull open to make the boat shape.Flatten the bottom — your paper boat is ready to float!`,
    },
    {
      id: 9,
      title: "Paper Fish",
      img: "/src/assets/paper2.jpg",
...
text: `Make a Paper Fish. You'll need: Colored paper, Scissors, Glue, Marker or crayons. Instructions: Fold the paper in half. Cut slits along the fold (not to the edge). Open the paper and curve it to form a fish shape. Glue the ends and draw eyes and scales. `,
...
text: `Make a Paper Sword. You'll need: Two sheets of paper, Tape or glue, Markers for design. Instructions: Fold one paper into a long stick shape for the blade. Fold the second paper into a small rectangle for the handle. Attach them with tape or glue. Decorate with colors or patterns.`,
