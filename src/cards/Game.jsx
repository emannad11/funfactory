    ...
    <div className="arrange-container">
      ...
      <div className="top-controls">
        ...
        <div className="btn-row">
          ...
          <button className="restart-btn1" onClick={handleRestart}>
            🔄 Restart
          </button>
        </div>
      </div>
      ...
      <p className="game-intro">
       First start the game then Look carefully and remember the order of the emojis! 👀 <br />
      ...
      {gameStarted && !gameOver && (
        <>
          <h3>
            Level {level + 1} / {sequencesData.length}
          </h3>
          <h4>⭐ Score: {score}</h4>

          <div className="timer-container">
            <div
              className={`timer-bar ${timer <= 10 ? "low-time" : ""}`}
